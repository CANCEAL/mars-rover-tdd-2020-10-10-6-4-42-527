...
class MarsRoverTest {
    private void getNewPosition(int locationX, int locationY, String heading, String command, int expectedLocationX, int expectedLocationY, String expectedHeading) throws CommandNotDefinedException {
        //given
    ...
    void should_return_x_negative_1_y_0_heading_N_when_execute_command_given_x_0_y_0_heading_n_and_command_MLMR() throws CommandNotDefinedException {
        getNewPosition(0, 0, "N", "MLMR", -1, 1, "N");
    }
