...
class MarsRoverTest {
    public void newPosition(int locationX, int locationY, String heading, String command, int expectedLocationX, int expectedLocationY, String expectedHeading) throws CommandNotDefinedException {
        //given
